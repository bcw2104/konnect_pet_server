...
public enum ResponseType {
	...
	// 내부 이슈로 실패 90XX
	FAIL("9000", "failed","부적절한 요청입니다."),
	SERVER_ERROR("9001", "internal server error","잠시 후 다시 시도해주세요."),

	// 요청 이슈로 실패 91XX
	INVALID_REQUEST("9101", "invalid request","부적절한 요청입니다."),
	INVALID_PARAMETER("9102", "invalid parameter", "부적절한 요청입니다."),

	//인증 실패 92XX
	AUTH_FAIL("9200", "auth failed", "아이디 또는 비밀번호가 일치하지 않습니다."),
